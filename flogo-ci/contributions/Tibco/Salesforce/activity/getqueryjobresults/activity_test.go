...
func TestGetQueryJobResults(t *testing.T) {
	...
	act := &GetQueryJobResultsActivity{}
	...
	assert.Nil(t, err)
	if err != nil {
		t.Errorf("Could not get query job results for account")
		t.Fail()
	} else {
