...
func SQLDrivers(environmentHandle SQLHENV, direction SQLUSMALLINT, driverDescription *SQLCHAR, bufferLength1 SQLSMALLINT, descriptionLengthPtr *SQLSMALLINT, driverAttributes *SQLCHAR , bufferLength2 SQLSMALLINT, attributesLengthPtr *SQLSMALLINT) (ret SQLRETURN) {
	r0, _, _ := syscall.Syscall9(procSQLDrivers.Addr(), 8, uintptr(environmentHandle), uintptr(direction),uintptr(unsafe.Pointer(driverDescription)), uintptr(bufferLength1) , uintptr(unsafe.Pointer(descriptionLengthPtr)), uintptr(unsafe.Pointer(driverAttributes)), uintptr(bufferLength2), uintptr(unsafe.Pointer(attributesLengthPtr)), 0)
	ret = SQLRETURN(r0)
	return
}
...
func SQLColAttribute(statementHandle SQLHSTMT, columnNumber SQLUSMALLINT, fieldIdentifier SQLUSMALLINT, characterAttribute SQLPOINTER, bufferLength SQLSMALLINT, stringLength *SQLSMALLINT, numericAttribute *SQLLEN) (ret SQLRETURN) {
	r0, _, _ := syscall.Syscall9(procSQLColAttribute.Addr(), 7, uintptr(statementHandle), uintptr(columnNumber), uintptr(fieldIdentifier), uintptr(characterAttribute), uintptr(bufferLength), uintptr(unsafe.Pointer(stringLength)), uintptr(unsafe.Pointer(numericAttribute)), 0, 0)
	ret = SQLRETURN(r0)
	return
}
...
func SQLGetConnectAttr(ConnectionHandle SQLHDBC, Attribute SQLINTEGER, ValuePtr SQLPOINTER, BufferLength SQLINTEGER, StringLengthPtr *SQLINTEGER)(ret SQLRETURN)  {
	r0, _, _ := syscall.Syscall6(procSQLGetConnectAttr.Addr(), 5, uintptr(ConnectionHandle), uintptr(Attribute), uintptr(ValuePtr), uintptr(BufferLength),  uintptr(unsafe.Pointer(StringLengthPtr)), 0) 
	ret = SQLRETURN(r0)
	return
}
