...
// Cors constructor
func New(prefix string, log log.Logger) Cors {
...
func (c cors) HandlePreflight(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set(ACCESS_CONTROL_ALLOW_HEADERS_HEADER, r.Header.Get(ACCESS_CONTROL_REQUEST_HEADER_HEADER))
...
func isValidAccessControlMethod(methodName string, prefix string, log log.Logger) bool {
	if methodName == "" {
...
func isValidAccessControlHeaders(headersStr string, prefix string, log log.Logger) bool {
	if headersStr == "" {
		return true
	}
