...
func (a *Activity) Eval(context activity.Context) (done bool, err error) {
	...
	logCache.Infof("Executing %s Insert Activity", dbType)
	...
	errString := fmt.Sprintf("%s-insert-4001", strings.ToLower(dbType))

	result, err := sharedmanager.PreparedInsert(query, inputParams, input.Fields, logCache)
	if err != nil {
