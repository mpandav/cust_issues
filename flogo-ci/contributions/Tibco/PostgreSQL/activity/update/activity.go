...
//Package update provides database query execution implementation for
...
func (a *Activity) Eval(context activity.Context) (done bool, err error) {
	...
	// logCache.Info("Executing PostgreSQL Update Activity")
	...
	logCache.Infof("Executing %s Update Activity", dbType)
	...
	errString := fmt.Sprintf("%s-update-4001", strings.ToLower(dbType))

	result, err := sharedmanager.PreparedUpdate(query, inputParams, input.Fields, logCache)
	if err != nil {
