...
func (a *Activity) Eval(context activity.Context) (done bool, err error) {
	...
	// logCache.Info("Executing PostgreSQL Query Activity")
	...
	logCache.Infof("Executing %s Query Activity", dbType)
	...
	errString := fmt.Sprintf("%s-query-4001", strings.ToLower(dbType))

	result, err := sharedmanager.PreparedQuery(query, inputParams, logCache)
	if err != nil {
