...
const (
	...
	SQL_INTERVAL_DAY     = C.SQL_C_INTERVAL_DAY
	SQL_INTERVAL_MONTH   = C.SQL_C_INTERVAL_MONTH
	SQL_INTERVAL_YEAR    = C.SQL_C_INTERVAL_YEAR
...
type (
	...
	SQLWCHAR     C.SQLWCHAR
	SQLSCHAR     C.SQLSCHAR
	SQLBIGINT    C.SQLBIGINT
	SQLDOUBLE    C.SQLDOUBLE
